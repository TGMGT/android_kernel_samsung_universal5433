...
extern int vfs_rename(struct inode *, struct dentry *, struct inode *, struct dentry *, struct inode **, unsigned int, unsigned int);
extern int vfs_rename2(struct vfsmount *, struct inode *, struct dentry *, struct inode *, struct dentry *, unsigned int);
extern int vfs_whiteout(struct inode *, struct dentry *, struct inode **, unsigned int);
...
extern int do_dentry_open(struct file *f, int (*open)(struct inode *, struct file *), const struct cred *cred);
