...
curl -A "$USER_AGENT" -LsS --connect-timeout 30 "https://codeload.github.com/WireGuard/wireguard-linux-compat/tar.gz/$VERSION" | tar -C "net/wireguard" -xJf - --strip-components=2 "wireguard-linux-compat-$VERSION/src"
